...
namespace SigmaExcel
{
    partial class SigmaExcel
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SigmaExcel));
            ...
            this.Name = "SigmaExcel";
            this.Text = "SigmaExcel";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FormExit_Click);
            this.Load += new System.EventHandler(this.SigmaExcel_Load);
